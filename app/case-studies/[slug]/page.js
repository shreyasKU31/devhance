...
import { ArrowLeft, Code, Layers, Lightbulb, TrendingUp, CheckCircle } from "lucide-react";
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-primary">
                    {caseStudy.proofData.commits}
                  </div>
                  <div className="text-xs text-muted-foreground">Commits</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary">
                    {caseStudy.proofData.files}
                  </div>
                ...
                <div className="col-span-2 sm:col-span-2 text-left pl-4 border-l">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {Object.keys(caseStudy.proofData.languages).slice(0, 3).map((lang) => (
                      <span key={lang} className="text-xs bg-background px-2 py-1 rounded border">
                        {lang}
                      </span>
                    ))}
                  </div>
